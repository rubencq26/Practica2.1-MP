...
public class Pruebas {
    public static void main(String[] args) {
        ...
        ClienteMovil cm= (ClienteMovil) c[1].clone();   c[2]=cm; cm.setNombre(c1.getNombre());
        cm.setFechaAlta(f1); cm.setFPermanencia(f1);
        f1.setFecha(4,4,2004); aux=cm.getFPermanencia();
        aux.setFecha(20, 20, 2020);   c[3]=new ClienteTarifaPlana("805W","Iker", fnac2, f1, 375.09f, "Española");
        c[4]=new ClienteTarifaPlana("953H","Paz", fnac3, 290.00f, "Polaca");
        ClienteTarifaPlana ct= (ClienteTarifaPlana) c[3].clone();
        c[5]=ct; ct.setNombre("Pepe"); ct.setNacionalidad("India");
        ct.setMinutos(500);   cm.ver();  ct.ver();
